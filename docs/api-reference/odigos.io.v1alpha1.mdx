...
<td>
<code>encoding/json.RawMessage</code>
</td>
<td>
   <p>Config is an object containing the config for this action.
Must be one of: [AddClusterInfoConfig], [DeleteAttributeConfig], [RenameAttributeConfig], [RenameAttributeConfig]</p>
</td>
</tr>
</tbody>
</table>
