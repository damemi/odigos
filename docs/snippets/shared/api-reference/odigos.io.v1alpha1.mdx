...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#NetworkMetrics"><code>common/api/instrumentationrules.NetworkMetrics</code></a>
</td>
<td>
