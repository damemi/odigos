...
import {
  ...
  GET_INTERROGATION_TRANSACTION_SAMPLE_TRACE,
  GET_INTERROGATION_TRANSACTION_CALL_TRIE,
  GET_GATEWAY_INFO,
  GET_GATEWAY_PODS,
...
const operations: OdigosApiOperations = {
  ...
  GET_INTERROGATION_TRANSACTION_SAMPLE_TRACE: {
    document: GET_INTERROGATION_TRANSACTION_SAMPLE_TRACE,
  },
  GET_INTERROGATION_TRANSACTION_CALL_TRIE: {
    document: GET_INTERROGATION_TRANSACTION_CALL_TRIE,
  },
