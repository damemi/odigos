...
require (
	...
	// OBI: damemi fork branch trace-map-pin
	go.opentelemetry.io/obi v0.0.0-20260323181229-d7ddddc8bad5
...
replace (
	...
	go.opentelemetry.io/obi => github.com/damemi/opentelemetry-ebpf-instrumentation v0.0.0-20260323181229-d7ddddc8bad5
)
